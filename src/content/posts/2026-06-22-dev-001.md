---
title: "기상청 단기예보 API 실전 가이드 — 최저기온이 안 나오는 진짜 이유"
...
tags: ["기상청API", "단기예보", "getVilageFcst", "공공데이터", "날씨API", "파이썬", "기상청격자좌표", "날씨봇", "개발일지"]
---
...
> 관련 글: [집 시놀로지 나스로 개인 봇 돌리다 오라클 클라우드 무료 서버로 옮긴 이유](/posts/2026-06-02-dev-001/) — 이 글의 봇을 24시간 어디서, 왜 그 서버에서 돌리는지에 대한 이야기.
