...
| **⚠️ 무수익 (낮음)** | `낮음` (Low) | 광고주가 아예 없는 정보성 단순 키워드 ➔ **클릭당 20원~50원 (용돈도 안 됨)** |

---

## 💻 3단계: [원클릭 AI 프롬프트] 데스크탑 앱에 복붙하세요
...
2. 기능 및 화면 표시:
   ...
   - 상업성 판정 결과 배지:
     * compIdx == "높음" ➔ "💎 고단가 황금 키워드 (클릭당 1,000원 이상 기대)"
     * compIdx == "중간" ➔ "⭐ 알짜 실속 키워드 (안정적 수익)"
     * compIdx == "낮음" ➔ "⚠️ 저단가 주의 (방문자 유입용)"
     * 그 외(값 없음 등) ➔ "❓ 판정 불가 (데이터 없음)"
...
> 🚀 **키워드 발굴부터 글쓰기 기획까지 10분 만에 끝내고 싶다면?**  
> 씨앗 단어 하나만 넣으면 숨은 롱테일 전수발굴은 물론, 오늘 배운 **고단가 광고 상업성 지표까지 엑셀 시트에 원클릭 정렬**해 드립니다.  
> 특히 **[PREMIUM 올인원 프로그램]**을 선택하시면, 네이버 스마트블록 C-Rank가 가장 좋아하는 **[차별화 질문형 제목 2종]과 [H2 3단 본문 목차 뼈대]까지 구글 AI가 시트에 다 채워주어 글쓰기 시간을 1시간에서 10분으로 압축**해 드립니다.  
> 👉 [크몽에서 평생 소장용 올인원 프로그램 확인하기 (클릭)](https://kmong.com/gig/785584)
